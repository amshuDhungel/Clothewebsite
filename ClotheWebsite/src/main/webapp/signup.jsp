...
<form action="register" method = "POST" class = "form-signup" >
  <div class="container">
    ...
    <!--  label><input type="checkbox" checked="checked" name="male" style="margin-bottom:15px"> Male</label -->
    <!--  label><input type="checkbox" checked="checked" name="female" style="margin-bottom:15px"> Female</label --> 
